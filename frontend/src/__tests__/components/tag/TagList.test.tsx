...
describe("TagList", () => {
  ...
  it("test_tag_list_add_tag", async () => {
    ...
    renderWithProviders(<TagList tags={sampleTags} onAdd={onAdd} />);
  ...
  it("test_tag_list_delete_tag", async () => {
    ...
    renderWithProviders(<TagList tags={sampleTags} onDelete={onDelete} />);
  ...
  it("test_tag_list_edit_tag", async () => {
    ...
    renderWithProviders(<TagList tags={sampleTags} onUpdate={onUpdate} />);
